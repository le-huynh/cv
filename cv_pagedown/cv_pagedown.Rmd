...
- **Programming**: R (advanced: published 1 package [<i class="fa-solid fa-up-right-from-square"></i>](https://lehuynh.rbind.io/project/package_lehuynh/)), Python, SAS, JAGS, Stan
...
### Toward personalized acute myeloid leukemia (AML) [<i class="fa-solid fa-up-right-from-square"></i>](https://lehuynh.rbind.io/project/proj_aml/)
...
### Development of predictive biomarker spectrum for neuropsychiatric systemic lupus erythematosus (NPSLE) [<i class="fa-solid fa-up-right-from-square"></i>](https://lehuynh.rbind.io/project/proj_npsle/)
...
### Bayesian predictive model for toxic cyanobacteria occurrence from eutrophication and climate data [<i class="fa-solid fa-up-right-from-square"></i>](https://lehuynh.rbind.io/project/proj_cyano/)
...
- Translated R cheat sheets (Git & GitHub, gtsummary, RStudio IDE) into Vietnamese [<i class="fa-solid fa-up-right-from-square"></i>](https://lehuynh.rbind.io/project/cheatsheet_vi_translation/)
